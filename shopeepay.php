...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_SESSION['captcha']) || $captcha != $_SESSION['captcha']) {
        ...
        $stmt->bind_param("idssdi", $order_id, $total_payment, $phone_number, $delivery_location, $delivery_fee, $_SESSION['user_id']);
...
<head>
    ...
    <title>Shopeepay Payment - FLOAT SMOOTHIES MEDAN</title>
